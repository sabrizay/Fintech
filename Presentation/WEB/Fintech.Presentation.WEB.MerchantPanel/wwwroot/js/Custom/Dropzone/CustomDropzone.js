    ...
    return function () {
        ...
        return function () {
            ...
            var s = {
                ...
                previewTemplate: '<div class="dz-preview dz-file-preview"><div class= "dz-image"> <img data-dz-thumbnail /></div>  <div class="dz-details">   <div class="dz-size"><span data-dz-size></span></div>  <div class="dz-filename"><span data-dz-name></span></div>    </div>    <div class="dz-progress"> <span class="dz-upload" data-dz-uploadprogress></span> </div>      <div class="dz-success-mark">     </div>    <div class="dz-error-mark">   </div></div > ',
                drop: function (e) {
                ...
                return d(i, [{
                    ...
                    value: function (e, t, n, r) {
                        ...
                        if (this.emit("addedfile", e), this.emit("complete", e), o) {
                            ...
                            e.dataURL = t, this.createThumbnailFromUrl(e, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.resizeMethod, this.options.fixOrientation, a, r)
            ...
            b.initClass(), b.version = "5.9.2", b.options = {}, b.optionsForElement = function (e) {
...
function AppentHiddenImages(data) {
...
function RemoveImages(data) {
    for (let i = 0; i < ImagesArry.length; i++) {
        if (ImagesArry[i] == data) {
            ImagesArry.splice(i, 1);
        }
    }
}
const ImagesArry = [];
